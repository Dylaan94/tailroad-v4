                          ...
                          return industryName ? (
                            <>
                              <button
                                key={industry._id}
                                type="button"
                                className="inline-flex items-center py-1 text-xs font-mono text-gray-400  rounded-full hover:bg-gray-800 transition-colors"
                          ...
                          return serviceName ? (
                            <>
                              <button
                                key={service._id}
                                type="button"
                                className="inline-flex items-center py-1 text-xs font-mono  rounded-full hover:bg-gray-800 transition-colors"
                                onClick={(e) => e.preventDefault()}
                              >
                                {serviceName}
